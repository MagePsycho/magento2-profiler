 ...
 */
namespace MagePsycho\Profiler\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    private const PRODUCT_NAME = 'Enhanced Profiler';

    private const PRODUCT_URL = 'https://www.magepsycho.com/magento2-enhanced-profiler.html';

    private const MODULE_NAME = 'MagePsycho_Profiler';

    private const VERSION_CACHE_KEY = 'magepsycho-Profiler-module-version';
